  ...
  public void visit(final ArmyDefinition n, final A argu) {
    ...
    if (n2.present()) {
      ...
      for (int i = 0; i < n2SeqA1Lst.size(); i++) {
        ...
        n2SeqA1LstEi.accept(this, argu);
      }
      final INode n2SeqA2 = n2Seq.elementAt(2);
      n2SeqA2.accept(this, argu);
    }
  }
      ...
      case 0:
        ...
        if (n2NSeq0A1Nlo.present()) {
          for (int i = 0; i < n2NSeq0A1Nlo.size(); i++) {
            ...
            n2NSeq0A1NloEi.accept(this, argu);
          }
        }
        final INode n2NSeq0A2 = n2NSeq0.elementAt(2);
        n2NSeq0A2.accept(this, argu);
        break;
      case 1:
