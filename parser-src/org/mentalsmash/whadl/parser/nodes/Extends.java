...
/**
 * JTB node class for the production Extends:<br>
 * Corresponding grammar :<br>
 * f0 -> < EXTENDS ><br>
 * f1 -> Pattern()<br>
 * f2 -> < SEMICOLON ><br>
 */
public class Extends implements INode {
   ...
   */
  public Extends(final NodeToken n0, final Pattern n1, final NodeToken n2) {
    f0 = n0;
    f1 = n1;
    f2 = n2;
  }
   ...
   * @param n0 first child node
   */
  public Extends(final Pattern n0) {
